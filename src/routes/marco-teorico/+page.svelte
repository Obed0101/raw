<script>
  ...
  // State variables del ejemplo base (se mantienen aunque no se usen para este contenido específico)
  let isModalOpen = $state(false);
  let currentPage = $state(1);
  let inputValue = $state("");

  // Sample data del ejemplo base (se mantienen aunque no se usen para este contenido específico)
  ...
  // Functions del ejemplo base (se mantienen aunque no se usen para este contenido específico)
...
<TerminalContainer>
  <!-- Header de la página, según el ejemplo -->
  <TerminalHeader title="MARCO TEÓRICO METROLÓGICO" showCursor>
    <!-- Puedes mantener la fecha/hora si es parte del diseño de la página -->
    <DateTime format="dd/mm/yyyy - hh:MM:ss" />
  </TerminalHeader>

  <!-- Aquí comienza la conversión del contenido HTML -->

  <!-- Título principal -->
  <TerminalTitle text="Marco teórico metrológico" />

  <!-- Sección: ¿Qué es la metrología...? -->
  <TerminalCard title="¿Qué es la metrología y por qué es fundamental en sistemas automatizados como un vivero inteligente?">
  ...
  <!-- Sección: Diferencias entre precisión, exactitud, error e incertidumbre -->
  <TerminalCard title="Diferencias entre precisión, exactitud, error e incertidumbre de medición">
    <!-- Nota: La negrita original se pierde al usar TerminalParagraph con texto plano -->
  ...
  <!-- Sección: Importancia de la calibración y trazabilidad -->
  <TerminalCard title="Importancia de la calibración de sensores y la trazabilidad metrológica">
  ...
  <!-- Sección: 1. ISO/IEC 17025 -->
  <TerminalCard title="1. ISO/IEC 17025 – Competencia en laboratorios de calibración">
    <!-- Nota: La negrita y el <br> original se pierden al usar TerminalList con texto plano -->
    <TerminalList items={[
      "Código: ISO 17025",
  ...
  <!-- Sección: 2. ISO 9847 -->
  <TerminalCard title="2. ISO 9847 – Calibración en condiciones ambientales reales">
    <TerminalList items={[
      "Código: ISO 9847",
  ...
  <!-- Sección: 3. OIML D11 -->
  <TerminalCard title="3. OIML D11 – Requisitos ambientales y seguridad para instrumentos electrónicos">
    <TerminalList items={[
      "Código: OIML D11",
  ...
  <!-- Sección: 4. NIST Handbook 44 -->
  <TerminalCard title="4. NIST Handbook 44 – Tolerancias y precisión en instrumentos de medición">
    <TerminalList items={[
  ...
  <!-- Sección: 5. ISO/IEC 25010 (con lista anidada simulada) -->
  <TerminalCard title="5. Norma adicional: ISO/IEC 25010 – Calidad del Software">
    <!-- Nota: La lista anidada se aplana y se simulan los puntos con guiones -->
    <TerminalList items={[
      ...
      "Aplicación del proyecto: - Calidad: El firmware en el MKR1010 y el dashboard implementan TLS/SSL para cifrar datos y proteger credenciales de usuario. - Fiabilidad: Se garantizan tiempos de actividad altos mediante manejo de errores en la conexión WiFi y reconexión automática si falla. - Usabilidad: La interfaz del dashboard es intuitiva: el usuario puede ver gráficas de temperatura/humedad e identificar alertas de forma visual sencilla."
    ]} />
  </TerminalCard>

  <!-- Título de la sección C -->
  <TerminalTitle text="C. Fundamentos prácticos" />

  <!-- Sección: 1. Sensores utilizados -->
  <TerminalCard title="1. Sensores utilizados">
    <!-- Sub-secciones para cada sensor (usando TerminalTitle dentro de la tarjeta) -->
    ...
    <TerminalTitle text="b) Sensor de humedad y temperatura del aire – AM1011A (similar al DHT11)" />
    <TerminalList items={[
  ...
  <!-- Sección: Cálculo de incertidumbre -->
  <TerminalCard title="2. Cálculo de incertidumbre – Ejemplo con DS18B20">
    ...
    <!-- Nota: La negrita original se pierde -->
  ...
  <!-- Sección: Ejemplo de error de medición -->
  <TerminalCard title="Ejemplo de error de medición con sensor de humedad del suelo (ME110)">
    ...
    <!-- Nota: La negrita original en los items de la lista se pierde -->
    <TerminalList items={[
  ...
  <!-- Sección: Referencias -->
  <TerminalCard title="Referencias">
    <TerminalList items={[
  ...
  <!-- El resto de componentes del ejemplo base (si los quieres mantener en la página) -->
  <!-- Si solo quieres el contenido del HTML, puedes eliminar estas secciones -->
  <!-- Por ahora, los dejo comentados o eliminados para centrarse en el contenido HTML -->
